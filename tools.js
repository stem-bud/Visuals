class tools
{
    ...
    */
    ...
    static rangeoverlap(smallRange1 = {end1: num, end2: num},smallRange2 = {end1: num, end2:num})
    {
        return (this.between(smallRange1.end1,smallRange2.end1,smallRange2.end2) || this.between(smallRange1.end2,smallRange2.end1,smallRange2.end2))
    }
    static between(num,r1,r2)
    {
